...
import { User, Mail, Phone, KeyRound, Shield, Building, UserCheck, Loader2, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="flex min-h-screen items-center justify-center bg-secondary p-4">
      ...
      <Card className="w-full max-w-lg shadow-2xl">
        <CardHeader className="text-center">
          <CardTitle className="font-headline text-2xl">Staff Registration</CardTitle>
          <CardDescription>
            Create an account for authorized personnel.
          </CardDescription>
        </CardHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <FormLabel>Role</FormLabel>
                     <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Control Room Staff">Control Room Staff</SelectItem>
                        </SelectContent>
                      </Select>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type="email" placeholder="jane.doe@example.gov" className="pl-10" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            <CardFooter className="flex flex-col gap-4">
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Register Staff Member"}
              </Button>
              <div className="text-center text-sm text-muted-foreground">
                Already have an account?{' '}
                <Link href="/login/organization" className="font-semibold text-primary underline-offset-4 hover:underline">
                  Login
                </Link>
              </div>
            </CardFooter>
