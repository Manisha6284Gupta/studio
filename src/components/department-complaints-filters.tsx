...
interface DepartmentComplaintsFiltersProps {
    onFilterChange: (filters: { applicationNumber?: string; status?: ComplaintStatus | 'all'; date?: Date }) => void;
}

export function DepartmentComplaintsFilters({ onFilterChange }: DepartmentComplaintsFiltersProps) {
    ...
    React.useEffect(() => {
        onFilterChange({ applicationNumber: applicationNumber || undefined, status, date });
    }, [applicationNumber, status, date, onFilterChange]);
